...
💡 Reminder that a **map** is basically a hash or dictionary in Go. We covered this in
...
💡 _There exist some laws that govern reflection in Go, but talking about them is beyond the scope 
